    ...
    <header className="sticky top-0 z-30 border-b border-slate-200/80 bg-white">
      <div className="flex h-14 items-center gap-2 px-3 sm:h-[60px] sm:gap-3 sm:px-4 lg:px-5">
        ...
        <div className="mx-auto hidden max-w-lg flex-1 md:block">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2 pl-10 pr-10 text-sm text-slate-700 placeholder:text-slate-400 focus:border-indigo-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-100"
            />
        ...
        <div className="ml-auto flex shrink-0 items-center gap-1 sm:gap-2">
          ...
          <div className="flex items-center gap-1.5 rounded-lg border border-slate-200 px-1.5 py-1 sm:gap-2 sm:px-2">
            <img
              src={user?.avatar}
              alt={user?.name}
      ...
      <div className="border-t border-slate-100 px-3 py-2.5 md:hidden">
        <div className="relative">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 pl-10 pr-10 text-sm text-slate-700 placeholder:text-slate-400 focus:border-indigo-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-100"
          />
          <ScanLine className="absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400" />
        </div>
      </div>
