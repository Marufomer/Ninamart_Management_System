    ...
    >
      ...
      <div className="px-3 pb-2">
        <a
          href="#"
          onClick={onNavClick}
          className="flex items-center gap-3 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 px-3 py-2.5 text-sm font-medium text-white shadow-md"
        >
                ...
                return (
                  <li key={item.name}>
                    <a
                      ...
                      className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-[13px] text-slate-300 transition hover:bg-sidebar-hover hover:text-white active:bg-sidebar-hover sm:py-2"
                    >
      ...
      <div className="border-t border-slate-700/50 p-3">
        <div className="flex cursor-pointer items-center gap-3 rounded-xl p-2 transition hover:bg-sidebar-hover">
          <img
